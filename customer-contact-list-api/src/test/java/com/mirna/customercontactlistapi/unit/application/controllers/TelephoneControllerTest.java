...
public class TelephoneControllerTest {
	...
	public void setUp() throws Exception {
		...
		MvcResult result = mockMvc.perform(MockMvcRequestBuilders.post("/api/v1.0/customers").contentType(MediaType.APPLICATION_JSON)
	...
	public void testPostTelephoneCustomer() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.post("/api/v1.0/telephones").contentType(MediaType.APPLICATION_JSON)
